...
export const DEFAULT_SUBJECTS = [
  {
    ...
    color: '#3b82f6',
    attended: 53,
    held: 57, // 93.6% -> 94% (Bunk till 90%: 1 class)
    room: 'Room 512'
  },
  {
    id: 'sub-fods',
    ...
    color: '#06b6d4',
    attended: 51,
    held: 53, // 97.7% -> 98% (Bunk till 90%: 3 classes)
    room: 'Room 512'
  },
  {
    id: 'sub-mis3',
    ...
    color: '#8b5cf6',
    attended: 39,
    held: 44, // 91.9% -> 92% (Bunk till 90%: 0 classes - on edge!)
    room: 'Room 512'
  },
  {
    id: 'sub-for',
  ...
  },
  {
    ...
    color: '#f59e0b',
    attended: 32,
    held: 36, // 89.7% -> 90% (<90%, bunks till 75%: 5 classes)
    room: 'Room 512'
  },
  {
    id: 'sub-ee',
...
export const ATTENDANCE_STORAGE_KEY = 'mits_s3_cs_ai_shawn_v1790259476';
