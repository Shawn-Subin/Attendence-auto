...
export const DEFAULT_SUBJECTS = [
  {
    ...
    color: '#3b82f6',
    attended: 48,
    held: 51, // 93.6% -> 94% (Bunk till 90%: 1 class)
    room: 'Room 512'
  },
  {
    id: 'sub-fods',
    ...
    color: '#06b6d4',
    attended: 44,
    held: 45, // 97.7% -> 98% (Bunk till 90%: 3 classes)
    room: 'Room 512'
  },
  {
    id: 'sub-mis3',
    ...
    color: '#8b5cf6',
    attended: 36,
    held: 39, // 91.9% -> 92% (Bunk till 90%: 0 classes - on edge!)
    room: 'Room 512'
  },
  {
    id: 'sub-for',
    ...
    color: '#10b981',
    attended: 34,
    held: 36, // 93.9% -> 94% (Bunk till 90%: 1 class)
    room: 'Room 512'
  },
  {
    id: 'sub-aoop',
    ...
    color: '#f59e0b',
    attended: 27,
    held: 30, // 89.7% -> 90% (<90%, bunks till 75%: 5 classes)
    room: 'Room 512'
  },
  {
    id: 'sub-ee',
    ...
    color: '#ec4899',
    attended: 25,
    held: 27, // 91.7% -> 92% (Bunk till 90%: 0 classes - on edge!)
    room: 'Room 512'
  },
  {
    id: 'sub-amh',
...
export const ATTENDANCE_STORAGE_KEY = 'mits_s3_cs_ai_shawn_v1789626528';
